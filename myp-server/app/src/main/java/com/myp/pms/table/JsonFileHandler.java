...
public class JsonFileHandler {
  ...
  public static <T> List<T> loadObject(File file, Class<T> elementType) {
    try (BufferedReader in = new BufferedReader(new FileReader(file))) {
      ...
      System.out.printf("%s 파일 데이터 로딩 중 오류발생!\n", file.getName());
      return new ArrayList<T>();
    }
  }

  public static <T> void saveObject(File file, List<T> list) {
